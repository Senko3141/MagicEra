--[[
	Credits to fresh for this module
]]
...
local function deepSearchFolder(Folder,Type,InfoTable)
	...
	for i,Object in ipairs(Children) do
		...
		elseif Object:IsA("Folder") or Object:IsA("ModuleScript") then
			deepSearchFolder(Object,Type,NewTable)
		end
	end
...
function AnimationHandler.LoadAnimations(Character,ClassNames)
	...
	for _,ClassName in ipairs(ClassNames) do
		local SharedAnimations = AnimationFolder

		local CachedShared = deepSearchFolder(SharedAnimations, "Animation")
...
function AnimationHandler.ClearAnimations(Character)
	...
	for AnimationName, _ in ipairs(Profile.LoadedAnimations) do
