...
return {
	[1] = {
		...
		Text = "Oi mate, fancy catching some vermin?",
		LastDialogue = false,
	...
	[2] = {
		canStart = function(...)
			...
			if PlayerData.QuestCooldowns:FindFirstChild("collect_squirrel") then
				if os.time() - PlayerData.QuestCooldowns["collect_squirrel"].Value < 75 then
					return false
				end
			end
	...
	["CAN'T INTERACT"] = {
		...
		Text = "Actually, seems they aren't an issue right now, come see me another time.",
		LastDialogue = false,
