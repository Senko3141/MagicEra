...
return {
	...
	[2] = {
		canStart = function(...)
			...
			if PlayerData.QuestCooldowns:FindFirstChild("collect_flowers") then
				if os.time() - PlayerData.QuestCooldowns["collect_flowers"].Value < 75 then
					return false
				end
			end
		...
		Text = "Thanks, I'll be waiting here for when you're done!",
		LastDialogue = true,
	...
	["CAN'T INTERACT"] = {
		...
		Text = "Actually, I don't need the job doing right now, come back at a later date.",
		LastDialogue = false,
