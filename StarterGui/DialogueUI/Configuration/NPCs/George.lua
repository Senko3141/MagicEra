...
return {
	[1] = {
		...
		Text = "Excuse me, could you help me, my cat has gone missing!",
		LastDialogue = false,
	...
	[2] = {
		canStart = function(...)
			...
			if PlayerData.QuestCooldowns:FindFirstChild("find_missing_cat") then
				if os.time() - PlayerData.QuestCooldowns["find_missing_cat"].Value < 75 then
					return false
				end
			end
	...
	["CAN'T INTERACT"] = {
		...
		Text = "Actually, I just remembered he came home.",
		LastDialogue = false,
