...
local flowerSpawns = workspace:WaitForChild("QuestData"):WaitForChild("Flower")
...
RunService.RenderStepped:Connect(function()	
	...
	if Closest ~= nil then
		...
		if not PlayerQuests:FindFirstChild("collect_flowers") then
...
UserInputService.InputBegan:Connect(function(Input, Processed)
	...
	if Input.KeyCode == Enum.KeyCode.E then
		if ChosenItem ~= nil then
			...
			Remotes.PickupFlower:FireServer(tonumber(ChosenItem.Name))
		end
	end
end)