...
local function createPrompt(prompt, inputType, gui)
	...
	frame.BackgroundColor3 = Color3.new(0.07, 0.07, 0.07)
	frame.Image = "rbxassetid://9893569896"
	frame.ClipsDescendants = true
	frame.Parent = promptUI
	...
	actionText.Font = Enum.Font.Fantasy
	...
	objectText.Font = Enum.Font.Fantasy
	...
	table.insert(tweensForButtonHoldBegin, TweenService:Create(frame, tweenInfoFast, { Size = UDim2.fromScale(0.5, 1), ImageTransparency = 1 }))
	table.insert(tweensForButtonHoldEnd, TweenService:Create(frame, tweenInfoFast, { Size = UDim2.fromScale(1, 1), ImageTransparency = 0.3 }))
	table.insert(tweensForFadeOut, TweenService:Create(frame, tweenInfoFast, { Size = UDim2.fromScale(0.5, 1), ImageTransparency = 1 }))
	table.insert(tweensForFadeIn, TweenService:Create(frame, tweenInfoFast, { Size = UDim2.fromScale(1, 1), ImageTransparency = 0.3 }))
	...
	elseif inputType == Enum.ProximityPromptInputType.Touch then
		...
		elseif buttonTextString ~= nil and buttonTextString ~= '' then
			...
			buttonText.Font = Enum.Font.Fantasy
